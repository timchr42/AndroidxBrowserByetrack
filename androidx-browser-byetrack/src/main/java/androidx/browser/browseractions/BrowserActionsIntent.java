 ...
 * You are strongly encouraged to use {@link Builder}.
 *
...
public class BrowserActionsIntent {
    ...
    public static final class Builder {
        ...
        /**
         * Constructs a {@link Builder} object associated with default setting
         * for a selected url.
    ...
    public static void openBrowserAction(@NonNull Context context, @NonNull Uri uri, int type,
        ...
        BrowserActionsIntent intent = new Builder(context, uri)
                .setUrlType(type)
